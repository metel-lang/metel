# Moonlane Module System: Implementation Report
...
The Known Limitations section in `moonlane-interpreter/docs/evaluator.md` still documents two problems that were fixed in sprint 13:
...
`moonlane-interpreter/docs/sprint-12-gap-analysis.md` has never been committed to the repository. It contains the full pre-implementation gap analysis from sprint 12, documenting why issues #205, #206, #189 were created and the decisions made during planning. It is useful historical context. It is addressed as Gap 5 in sprint 14's issue #216.
